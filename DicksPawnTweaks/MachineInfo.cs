...
using System.Linq;
// Class that holds all the machines information and calculates values for a total price
...
namespace DicksPawnTweaks
{
    ...
    {   
        ...
        private long getHDD()
        {
            ...
            ManagementObjectSearcher mos = new ManagementObjectSearcher(/*"root\\CIMV2", */"SELECT * FROM Win32_DiskDrive WHERE MediaType = 'Fixed hard disk media'");
